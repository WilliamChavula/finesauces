...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('listings', '0002_auto_20210120_2034'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Created', 'Created'), ('Processing', 'Processing'), ('Shipped', 'Shipped'), ('Readyfor pickup', 'Ready for pickup'), ('Completed', 'Completed')], default='Created', max_length=20)),
